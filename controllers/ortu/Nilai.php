...
class Nilai extends CI_Controller
{
	...
	public function index()
	{
		...
		$data['nilai'] =  $this->MNilai->siswa_nilai(tahun_aktif(), $data['id_semester'], $session_ortu['id_siswa']);
		$data['nilai_rata_rata'] = $this->MNilai->nilai_rata_rata_akhir(tahun_aktif(), $data['id_semester'], $session_ortu['id_siswa']);
		// echo '<pre>';
		// print_r($data['nilai']); 
		// echo '</pre>';

		$this->load->view('ortu/header');
		$this->load->view('ortu/nilai/tampil', $data);
